...
import { CreateRoomData, CreateRoomPayload, ImportRoomData, ImportRoomPayload } from "./data-contracts";
...
export class RoomService {
   ...
   */
  createRoom(data: CreateRoomPayload): Observable<CreateRoomData> {
  ...
  importRoom(data: ImportRoomPayload): Observable<ImportRoomData> {
    return this.http.post<ImportRoomData>(this.url + `/Room/import`, data);
  }
}
